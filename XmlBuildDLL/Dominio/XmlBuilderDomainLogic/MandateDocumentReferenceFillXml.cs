...
{
    internal class MandateDocumentReferenceFillXml
    {
        internal static XElement FillMandateDocumentReference(DocumentReference mandante, string nameNode)
        {
            ...
            XElement Period = DocumentReferencePeriodXmlFill.FillDocRefPeriod(mandante);
            if (nodeAttachment != null && nodeAttachment.HasElements)
